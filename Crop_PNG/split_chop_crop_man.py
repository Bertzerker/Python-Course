...
class CropWorker(QObject):
    ...
    def _iter_halves(self, im: Image.Image) -> Iterable[Tuple[str, Image.Image, str, str]]:
        """Yield halves with optional center gutter (book spine) removed.
        Returns tuples of (tag, image, anchor_x, anchor_y).
        """
        ...
        if mode == "vertical":
            ...
            if g >= W:
                # Entire width trimmed; nothing to produce
                return
            left_end = (W - g) // 2
...
class MainWindow(QWidget):
    def __init__(self):
        ...
        # Center trim (book spine) in pixels
